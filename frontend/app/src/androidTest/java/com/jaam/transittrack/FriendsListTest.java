...
public class FriendsListTest {
    ...
    public void testAddFriends() throws InterruptedException {
        ...
        onView(ViewMatchers.withId(R.id.friendEmailEditText)).perform(typeText(defaultFriend1));
    ...
    public void testRefreshFriendsList() throws InterruptedException {
        ...
        onView(ViewMatchers.withId(R.id.friendsListRefreshButton)).perform(click());
    ...
    private void navigateToFriendsList() throws InterruptedException {
        ...
        onView(ViewMatchers.withId(R.id.addressEditText)).perform(typeText(defaultAddress));
