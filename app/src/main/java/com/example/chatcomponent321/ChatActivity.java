...
////    private String SERVER_PATH = "ws://4.205.17.106:8081";
//    private String SERVER_PATH = "http://4.205.17.106:8081";
//
////    private String SERVER_PATH = "http://4.205.17.106:8081/api/chat/send";
//
...
//
//            Request request = new Request.Builder()
//                    .url("http://4.205.17.106:8081/api/chat/send") // Use the correct URL
//                    .post(requestBody)
//                    .build();
//
//            OkHttpClient client = new OkHttpClient();
...
//
//            // Clear the message edit text or perform any UI update after sending the message
//            // You can update your UI here when the message is sent.
//        } catch (JSONException e) {
//            e.printStackTrace();
//        }
//    }
...
//    private String SERVER_PATH = "ws://206.87.217.198:5000"; // WebSocket server path
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayAdapter = new ArrayAdapter<>(this, R.layout.message_layout, R.id.messageTextView, messageHistory);
        ...
        public void onMessage(WebSocket webSocket, String text) {
            ...
            runOnUiThread(() -> {
                ...
                try {
                    JSONObject jsonObject = new JSONObject(text);
                    jsonObject.put("isSent", false);
                    jsonObject.put("senderEmail","d.trump@example.com");
...
//        clearMessages();
        ...
        for (int i = 0; i < chatHistory.length(); i++) {
            try {
                ...
                messagesArrayList.add(currMsg);arrayAdapter.add(message.getString("senderEmail")+message.getString("text"));
